                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="main-heading">
                                ...
                                <p>
                                   Chez <strong>Atlas Consulting IT</strong>, Nous croyons que la <strong>technologie</strong> est un levier de
                                   croissance incontournable. De la <strong>formation des talents</strong> à la mise en place d’infrastructures réseau 
                                   et de solutions de <strong>cybersécurité</strong>, en passant par l’intégration de l’<strong>IA</strong>, 
                                   nous aidons nos clients à relever les défis du numérique et à transformer leurs ambitions en résultats concrets.
                                </p>
